...
const DATA = {
  ...
  options: [
    {
      ...
      score: 8.0,
      summary: "Phase 1 (~$20–40K): finish the last unfinished corner of the lower level — completing a true second living zone for the boys — plus a '1965 allowance' for the wiring and flooring surprises a 60-year-old house owes you. (The house already has central air, added a few years ago — the assessor card's '0% cooling' is stale.) Phase 2, only if the family still feels tight (~$110–185K all-in): a 300–400 sq ft rear family-room addition on the lot's ~53 ft of by-right depth (pending a right-of-way survey). Both phases financeable with a second lien that never touches the likely ~3.1% first mortgage.",
      pros: [
      ...
      foot: [ { k: "Phase 1", v: "$20–40K" }, { k: "Phase 2 (opt.)", v: "$110–185K" } ],
    },
    {
  ...
  experts: [
    ...
    },
    {
      ...
      catchTitle: "What I caught",
      catch: "The draft refuted its own Phase-2 price on the same screen: its twelve line items summed to $87–151K in hard costs, plus its own 15–25% soft-cost rule — yet the headline said $75–160K. And the engineered header for the rear-wall opening appeared in no line item at all. Honest all-in: $110–185K. Also: 'existing forced-air ducts' was an inference from an assessor discrepancy, stated as fact — and the draft's Phase-1 AC price ran through it. (Resolved July 27: the family confirmed central air was installed a few years ago — the duct question is settled, and the AC scope dropped out of Phase 1 entirely.)",
    },
    {
  ...
  corrections: [
    ...
    "<b>Owner update (July 27, 2026): the house already has central air</b> — installed a few years ago; the assessor card's '0% cooling' is stale. Phase 1 re-scoped from 'AC + finish' ($32–60K) to the <b>lower-level finish + 1965 allowance (~$20–40K)</b>; the duct-inspection gate and heat-pump-rebate checklist items were retired. This also confirms the forced-air conversion the draft had only inferred.",
  ],
  ...
  addition: {
    intro: "This is a 54×26 raised ranch: one 1,505 sq ft living level over a 1,404 sq ft lower level that already contains a 571 sq ft finished rec room with a fireplace, a third full bath, laundry — and the 2-car tuck-under garage (~480 sq ft). So the truly finishable remainder is only ~350 sq ft, and there is no cheap way up: the roof is low-pitch and the garage sits under the bedrooms. What the house lacks isn't bedrooms, baths, or comfort systems — it has 4 bedrooms, 3 full baths, and central air added a few years ago (the assessor card's '0% cooling' is stale; owner-confirmed July 2026) — it's above-grade living space. The lot, though, is the asset: 0.92 verified-conforming acres with ~53 ft of by-right buildable depth behind the house, public sewer, no mapped wetlands.",
    ...
    scenarios: [
      { key: "REC", plan: "Recommended", short: "Lower-level finish (Phase 1)", name: "Phase 1 — Finish the last corner of the lower level", tag: "Recommended first move", get: "Finish the ~350 sq ft unfinished workshop corner, completing the lower level as a full second living zone: rec room, playroom, bath, laundry. The house already has whole-house central air (owner-confirmed, added a few years ago) — which also settles the duct question the review panel raised: the forced-air conversion is real.", lo: 20000, hi: 40000, sqft: "+250–350 sf finished", recoup: "60–71% on the finish", time: "1–2 mo", note: "Includes a $5–10K '1965 allowance': asbestos-tile testing in the workshop corner, aluminum branch-wiring check, lead-safe work practices. (The panel-upgrade line dropped out — a recent AC install would already have required adequate service.)", rec: true },
      ...
      { key: "C", plan: "Combo", short: "Finish + addition combo", name: "Lower-level finish + rear addition", tag: "The full solution", get: "Phase 1 and Phase 2 together: a fully finished lower level and a new above-grade family room — the house functionally jumps from ~2,075 to ~2,800 usable sq ft.", lo: 130000, hi: 225000, sqft: "+~700 usable sf", recoup: "~35–50% blended", time: "6–9 mo", note: "The upper half of this range crosses the ~$150K ceiling AND can breach 80% CLTV at the low end of the value range — phase it, re-appraise after Phase 1, and stop when the house feels right.", rec: false },
    ...
    lineItems: [
      ...
      { item: "HVAC extension", pct: 7, note: "~$6–11K · extend the existing forced-air + AC system; verify condenser capacity for the added load" },
  ...
  floorplans: {
    ...
    panelConsensus: "Panel consensus: Phase 1 (the lower-level finish) is a no-drawing-needed interior project. The Phase-2 rear family room fits the verified ~53 ft of by-right rear depth with a straightforward elevated foundation; its only real design work is the rear-wall opening and the deck rebuild.",
    existing: [
      {
    ...
    options: [
      {
        key: "REC", plan: "Phase 1", title: "Finish the workshop corner — completing the lower level",
        ...
        structural: [
          ...
          "No HVAC scope: the house already has central air on the forced-air system (owner-confirmed, added a few years ago) — just extend a supply and return into the newly finished room and verify capacity.",
  ...
  stress: {
    ...
    assumptions: [
      ...
      { a: "A ~$20–40K Phase 1 actually relieves the family's squeeze.", status: "Motivated", load: "Very high", challenge: "The family asked about space. Phase 1 finishes ~350 sq ft below grade — ZERO above-grade square footage. The CFP's numbers sharpen this: Option B's extra ~1,300 sq ft costs about $8/sq ft/yr, genuinely cheap for space — and the corrected Phase 2 buys a quarter of that space at a worse marginal rate (8.1% vs 6.6%).", flip: "If the boys' bedrooms (likely ~10×11) are the pain, only a move truly solves it — set the space slider honestly and let the calculator say so." },
